...
def load_usaf_target(file_path):
    return pp.imread(file_path)

usaf_image = load_usaf_target('raster_usaf.png')
usaf_image_rescaled = np.resize(usaf_image, (512,512))

amplitude = usaf_image_rescaled
